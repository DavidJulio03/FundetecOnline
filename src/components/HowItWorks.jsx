...
import { UserPlus, Monitor, BookOpen, GraduationCap, ChevronRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-28">
          ...
          <h2 className="text-[34px] sm:text-[42px] md:text-6xl font-[900] text-gray-900 leading-[1.1] tracking-tighter mb-6">
            TU CAMINO AL ÉXITO <br className="hidden sm:block" />
          ...
          <p className="text-gray-500 text-base md:text-lg font-medium leading-relaxed max-w-2xl mx-auto">
            Diseñamos una experiencia sin fricciones para que tu única preocupación sea aprender y crecer profesionalmente.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          {/* LÍNEA CONECTORA DESKTOP (Horizontal) 
              Ajustada para que flote exactamente detrás del centro de los iconos */}
          ...
          {/* LÍNEA CONECTORA MÓVIL (Vertical) 
              Ajustada para que pase exactamente por el centro del icono de 80px (40px + padding lateral) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-12 md:gap-y-16 gap-x-8 relative z-10">
            {steps.map((step, idx) => (
              <div key={idx} className="group flex flex-row lg:flex-col items-start lg:items-center gap-6 lg:gap-0">
                ...
                {/* Contenedor Visual (Icono y Número) */}
                <div className="relative shrink-0 lg:mb-8">
                  {/* Número de paso con diseño refinado */}
                  ...
                  {/* Contenedor del Icono - Z-index superior para tapar la barra detrás */}
                  ...
                  {/* Icono de dirección sutil para desktop */}
                  {idx !== steps.length - 1 && (
        ...
        <div className="mt-20 md:mt-28 text-center px-4">
          <button className="w-full sm:w-auto bg-gray-900 text-white px-10 py-5 rounded-[20px] font-black text-xs uppercase tracking-[0.2em] hover:bg-[#4aa82c] transition-all duration-300 shadow-2xl shadow-gray-200 flex items-center justify-center gap-3 mx-auto group">
            Empezar mi transformación
            <ChevronRight size={18} className="group-hover:translate-x-1 transition-transform" />
          </button>
          <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-6">
            Sin compromisos iniciales • Asesoría 100% gratuita
          </p>
        </div>
